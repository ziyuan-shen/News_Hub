...
# A tibble: 3 x 2
  name    title                                                 
  <chr>   <chr>                                                 
1 Reuters Healthcare may trump Brexit in battle for British vote
2 Reuters Warren's big healthcare plan relies on big assumptions
3 Reuters Warren's big healthcare plan relies on big assumptions
```
